...
export default class App extends Component {
    ...
    sendEmail = () => {
        ...
        if (email.length == 0) {
            ...
            try {
                fetch(`https://appbonus.justcode.am/api/ForgotPassword`, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
    ...
    confirmCode = () => {
        ...
        if (code1.length == 0 || code2.length == 0 || code3.length == 0 || code4.length == 0 || code5.length == 0) {
            ...
            try {
                fetch(`https://appbonus.justcode.am/api/ResetCodePassword`, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
                    ...
                    body: JSON.stringify({
                        email: email,
                        forgot_code: parseInt(this.getCode()),
                    })
        ...
        if (newPassword.length == 0 || repeatPassword.length == 0) {
            ...
            if (repeatPassword.length == 0) {
                this.setState({
                    ...
                    repeatPassword_error_text: 'El campo de confirmación de contraseña es obligatorio.'
                })
            } else {
                this.setState({
                    repeatPassword_error: false,
            ...
            try {
                fetch(`https://appbonus.justcode.am/api/NewPassword`, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/json',
                    ...
                    if (response.hasOwnProperty('password_confirmation')) {
                        if (response.password_confirmation[0] == 'The password confirmation and password must match.') {
                            this.setState({
                                repeatPassword_error: true,
                                repeatPassword_error_text: 'La confirmación de la contraseña y la contraseña deben coincidir.',
                            })
                        } else {
                            this.setState({
                                repeatPassword_error: false,
    ...
    render() {
                ...
                <View style={styles.recovery_password_phone_code_popup}>
                    <View style={styles.recovery_password_phone_code_popup_wrapper}>
                        ...
                        <KeyboardAwareScrollView
                            style={styles.recovery_account_code_main_wrapper}
        ...
        if (this.state.new_password_popup) {
            return (
                <View style={styles.new_password_popup}>
                    <View style={styles.new_password_popup_wrapper}>
                        ...
                        <KeyboardAwareScrollView
                            style={styles.new_password_main_wrapper}
                            enableOnAndroid={true}
                            enableAutomaticScroll={(Platform.OS === 'ios')}
                        >
                            ...
                            <Text style={styles.new_password_second_title}>
                                Cree una contraseña compleja que contenga letras mayúsculas y minúsculas, así como números y símbolos
                            </Text>
                            ...
                            <View style={styles.new_password_input_title_wrapper}>
                                <Text style={styles.new_password_input_title}>
                            ...
                            <TouchableOpacity style={styles.new_password_send_code_btn} onPress={() => this.setNewPassword()}>
                                <Text style={styles.new_password_send_code_btn_text}>Confirmar</Text>
                            </TouchableOpacity>
                        </KeyboardAwareScrollView>
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <KeyboardAwareScrollView
                    style={styles.recovery_account_email_main_wrapper}
                    enableOnAndroid={true}
                    enableAutomaticScroll={(Platform.OS === 'ios')}
                >
                    ...
                    <View style={styles.recovery_account_email_input_wrapper}>
                        <Text style={styles.recovery_account_email_input_title}>
                            Email correo</Text>
                        <TextInput
